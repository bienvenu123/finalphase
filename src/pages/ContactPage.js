    ...
    <div className="contact-page">
      ...
      <div className="contact-navigation">
        <Link to="/" className="nav-btn nav-btn-home">
          <svg className="nav-btn-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="contact-container">
        ...
        <div className="contact-info-section">
          ...
          <p className="contact-description">
            We'd love to hear from you. Whether you have a question about our orthopaedic services or need specialized care, our team is ready to help.
          </p>
